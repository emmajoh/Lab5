...
Rectangle::Rectangle(Point p1, Point p2, Color color) {
    start = p1;
    end = p2;
    colorTopLeft = color;
    colorTopRight = color;
...
Rectangle::Rectangle(Point p1, Point p2, Color cTopLeft, Color cTopRight, Color cBottomRight, Color cBottomLeft) {
    start = p1;
    end = p2;
